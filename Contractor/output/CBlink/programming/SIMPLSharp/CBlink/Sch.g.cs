...
namespace CBlink
{
    public interface ISch
    {
        ...
        event EventHandler<UIEventArgs> Save;
        event EventHandler<UIEventArgs> Mo7;
        event EventHandler<UIEventArgs> Tu7;
        event EventHandler<UIEventArgs> We7;
        event EventHandler<UIEventArgs> Th7;
        event EventHandler<UIEventArgs> Fr7;
        event EventHandler<UIEventArgs> Sa7;
        event EventHandler<UIEventArgs> Su7;
        event EventHandler<UIEventArgs> e1set;
        event EventHandler<UIEventArgs> e2set;
        event EventHandler<UIEventArgs> e3set;
        event EventHandler<UIEventArgs> e4set;
        event EventHandler<UIEventArgs> e5set;
        event EventHandler<UIEventArgs> e6set;
        event EventHandler<UIEventArgs> e7set;
        event EventHandler<UIEventArgs> e8set;
        ...
        void fbMo7(SchBoolInputSigDelegate callback);
        void fbTu7(SchBoolInputSigDelegate callback);
        void fbWe7(SchBoolInputSigDelegate callback);
        void fbTh7(SchBoolInputSigDelegate callback);
        void fbFr7(SchBoolInputSigDelegate callback);
        void fbSa7(SchBoolInputSigDelegate callback);
        void fbSu7(SchBoolInputSigDelegate callback);
    ...
    internal class Sch : ISch, IDisposable
    {
        ...
        private static class Joins
        {
            internal static class Booleans
            {
                ...
                public const uint Save = 61;
                public const uint Mo7 = 62;
                public const uint Tu7 = 63;
                public const uint We7 = 64;
                public const uint Th7 = 65;
                public const uint Fr7 = 66;
                public const uint Sa7 = 67;
                public const uint Su7 = 68;
                ...
                public const uint fbMo7 = 62;
                public const uint fbTu7 = 63;
                public const uint fbWe7 = 64;
                public const uint fbTh7 = 65;
                public const uint fbFr7 = 66;
                public const uint fbSa7 = 67;
                public const uint fbSu7 = 68;
            }
            internal static class Strings
            {
                public const uint e1set = 12;
                public const uint e2set = 13;
                public const uint e3set = 14;
                public const uint e4set = 15;
                public const uint e5set = 16;
                public const uint e6set = 17;
                public const uint e7set = 18;
                public const uint e8set = 19;
        ...
        private void Initialize(uint controlJoinId)
        {
            ...
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Save, onSave);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Mo7, onMo7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Tu7, onTu7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.We7, onWe7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Th7, onTh7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Fr7, onFr7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Sa7, onSa7);
            ComponentMediator.ConfigureBooleanEvent(controlJoinId, Joins.Booleans.Su7, onSu7);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e1set, one1set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e2set, one2set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e3set, one3set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e4set, one4set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e5set, one5set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e6set, one6set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e7set, one7set);
            ComponentMediator.ConfigureStringEvent(controlJoinId, Joins.Strings.e8set, one8set);
        ...
        public event EventHandler<UIEventArgs> Save;
        private void onSave(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Save;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Mo7;
        private void onMo7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Mo7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Tu7;
        private void onTu7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Tu7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> We7;
        private void onWe7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = We7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Th7;
        private void onTh7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Th7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Fr7;
        private void onFr7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Fr7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Sa7;
        private void onSa7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Sa7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> Su7;
        private void onSu7(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = Su7;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }
        ...
        public void fbMo7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbMo7], this);
            }
        }

        public void fbTu7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbTu7], this);
            }
        }

        public void fbWe7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbWe7], this);
            }
        }

        public void fbTh7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbTh7], this);
            }
        }

        public void fbFr7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbFr7], this);
            }
        }

        public void fbSa7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbSa7], this);
            }
        }

        public void fbSu7(SchBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.fbSu7], this);
            }
        }

        public event EventHandler<UIEventArgs> e1set;
        private void one1set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e1set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e2set;
        private void one2set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e2set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e3set;
        private void one3set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e3set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e4set;
        private void one4set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e4set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e5set;
        private void one5set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e5set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e6set;
        private void one6set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e6set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e7set;
        private void one7set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e7set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }

        public event EventHandler<UIEventArgs> e8set;
        private void one8set(SmartObjectEventArgs eventArgs)
        {
            EventHandler<UIEventArgs> handler = e8set;
            if (handler != null)
                handler(this, UIEventArgs.CreateEventArgs(eventArgs));
        }
